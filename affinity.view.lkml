...
#     sortkeys: ["prod_id", "user_id", "order_id"]
    sql: SELECT
      ...
      FROM thelook_events.ORDER_ITEMS oi
      LEFT JOIN thelook_events.INVENTORY_ITEMS ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN thelook_events.PRODUCTS p
...
#     sortkeys: ["prod_id"]
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM thelook_events.ORDER_ITEMS oi
      LEFT JOIN thelook_events.INVENTORY_ITEMS inventory_items
